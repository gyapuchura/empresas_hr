...
$file_name = $_FILES['file']['name'];
    ...
    $new_name_file = null;
        ...
        $ins = $link->query(" INSERT INTO bitacora_estado (idcorres, correlativo, idestado, resumen, codigo_doc, archivo_id, hash) VALUES ('$idcorres','$numero','$idestado','$resumen','$codigo_doc','$archivo_id','$hash_in') ");
        
        echo 'EL DOCUMENTO ADJUNTO A LA HOJA DE RUTA FUE GUARDADO CORRECTAMENTE';
        } else {
        echo 'ERROR AL SUBIR, EL ARCHIVO YA EXISTE CON EL CODIGO DE DOCUMENTO !!!';
        }
