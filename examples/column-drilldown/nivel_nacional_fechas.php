...
$link0=Conectarse();
$sql0 = " SELECT * FROM eventoi WHERE gestion='$gestion' AND inicio BETWEEN '$inicio_ss' AND '$fin_ss' ";
$result0 = mysql_query($sql0, $link0);
$total = mysql_num_rows($result0);

$link=Conectarse();
$sql = " SELECT * FROM eventoi WHERE iddepartamento='1' AND gestion='$gestion' AND inicio BETWEEN '$inicio_ss' AND '$fin_ss'";
$result = mysql_query($sql, $link);
$ben = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM eventoi WHERE iddepartamento='2' AND gestion='$gestion' AND inicio BETWEEN '$inicio_ss' AND '$fin_ss'";
$result = mysql_query($sql, $link);
$cba = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM eventoi WHERE iddepartamento='3' AND gestion='$gestion' AND inicio BETWEEN '$inicio_ss' AND '$fin_ss'";
$result = mysql_query($sql, $link);
$chu = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM eventoi WHERE iddepartamento='4' AND gestion='$gestion' AND inicio BETWEEN '$inicio_ss' AND '$fin_ss'";
$result = mysql_query($sql, $link);
$lpz = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM eventoi WHERE iddepartamento='5' AND gestion='$gestion' AND inicio BETWEEN '$inicio_ss' AND '$fin_ss'";
$result = mysql_query($sql, $link);
$oru = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM eventoi WHERE iddepartamento='6' AND gestion='$gestion' AND inicio BETWEEN '$inicio_ss' AND '$fin_ss'";
$result = mysql_query($sql, $link);
$pnd = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM eventoi WHERE iddepartamento='7' AND gestion='$gestion' AND inicio BETWEEN '$inicio_ss' AND '$fin_ss'";
$result = mysql_query($sql, $link);
$pts = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM eventoi WHERE iddepartamento='8' AND gestion='$gestion' AND inicio BETWEEN '$inicio_ss' AND '$fin_ss'";
$result = mysql_query($sql, $link);
$scz = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM eventoi WHERE iddepartamento='9' AND gestion='$gestion' AND inicio BETWEEN '$inicio_ss' AND '$fin_ss'";
$result = mysql_query($sql, $link);
    ...
    Highcharts.data({
        ...
        parsed: function (columns) {
            ...
            $('#container').highcharts({
                ...
                title: {
                    text: 'EVENTOS DE CAPACITACIÓN DEL <?echo $inicio_ss;?> AL <?echo $fin_ss;?> '
                },
                subtitle: {
