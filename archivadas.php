...
<section id="inner-headline">
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<h2 class="pageTitle">ARCHIVO DE COMUNICACIONES INTERNAS</h2>
			</div>
		</div>
	</div>
</section>
...
$sql.=" corres.anexo, estado.estado FROM corres, estado WHERE corres.idestado=estado.idestado ORDER BY corres.idcorres";
