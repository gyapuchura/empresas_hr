...
$tipoproblema =  $_GET['tipoproblema'];
...
<?php
$link0=Conectarse();
$sql0 = " SELECT * FROM soporte WHERE tecnico='$tecnico' AND tipoproblema='$tipoproblema'";
$result0 = mysql_query($sql0, $link0);
...
$sql.= " FROM soporte WHERE tecnico='$tecnico' AND tipoproblema='$tipoproblema' ORDER BY idsoporte ";
