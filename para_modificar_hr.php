...
<section id="inner-headline">
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<h2 class="pageTitle">MODIFICAR HOJAS DE RUTA</h2>
			</div>
		</div>
	</div>
</section>
...
$sql.=" anexo, idestado, codigo, origen FROM corres WHERE gestion='$gestion' AND idusuario='$idusuario_ss' ORDER BY idcorres";
...
?>
      ...
      <td>
	  <form name="DERIVA" action="valida_hoja_ruta_mod.php" method="post">
	  <input type="hidden" id="idcorres"  name="idcorres" value="<?php echo $row[0];?>">
	  <button type="submit" class="btn-link">MODIFICAR HOJA DE RUTA</button>
	  </form>
	  </td>
      </tr>
 <?php
