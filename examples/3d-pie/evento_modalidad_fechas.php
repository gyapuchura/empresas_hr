...
$link=Conectarse();
$sql = " SELECT * FROM eventoi WHERE idmodalidad='1' AND gestion='$gestion' AND inicio BETWEEN '$inicio_ss' AND '$fin_ss' ";
$result = mysql_query($sql, $link);
$presencial = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM eventoi WHERE idmodalidad='2' AND gestion='$gestion' AND inicio BETWEEN '$inicio_ss' AND '$fin_ss' ";
$result = mysql_query($sql, $link);
$semi = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM eventoi WHERE idmodalidad='3' AND gestion='$gestion' AND inicio BETWEEN '$inicio_ss' AND '$fin_ss' ";
$result = mysql_query($sql, $link);
$virtual = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM eventoi WHERE idmodalidad='4' AND gestion='$gestion' AND inicio BETWEEN '$inicio_ss' AND '$fin_ss'";
$result = mysql_query($sql, $link);
...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'PORCENTAJE DE EVENTOS POR MODALIDAD DE CAPACITACION DEL <?echo $inicio_ss;?> AL <?echo $fin_ss;?> '
        },
        tooltip: {
