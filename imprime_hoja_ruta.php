...
<table width="688" border="0" align="center" cellspacing="0">
  ...
  <tr>
    <td colspan="3" align="center"><table width="349" border="1" cellspacing="0">
      <tbody>
        <tr>
          <td width="343" align="center"><strong>HOJA DE RUTA:  <?php echo $row1[9];?></strong></td>
        </tr>
      </tbody>
    </table></td>
  </tr>
                ...
                <td width="265"><table width="261" border="1" cellspacing="0">
                  <tbody>
                    <tr>
                     ...
                     <?php 
$sqld =" SELECT nombres.nombres, nombres.paterno, nombres.materno, nombres.titulo FROM nombres, usuarios  ";
                      ...
                      <td><table width="180" border="1" cellspacing="0">
                        <tbody>
                          ...
                          <td width="246" align="center" style="font-family: 'Times New Roman'; font-size: 10px;">  
                            ...
                            <p>&nbsp;</p>
                              <?php 
$sqlor =" SELECT nombres.nombres, nombres.paterno, nombres.materno, nombres.titulo FROM nombres, usuarios  ";
$sqlor.=" WHERE usuarios.idnombre=nombres.idnombre AND usuarios.idusuario='$row[2]' ";
$resultor = mysqli_query($link,$sqlor);
$rowor = mysqli_fetch_array($resultor);
?>

<?php echo $rowor[3];?> <?php echo $rowor[0];?> <?php echo $rowor[1];?> <?php echo $rowor[2];?>
