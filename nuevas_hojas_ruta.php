...
$sql.=" corres.referencia, deriva_corres.comentario, deriva_corres.fecha_deriva, deriva_corres.idcorres, corres.codigo, corres.origen FROM deriva_corres, corres, instruccion ";
...
?>
      ...
      <td>
<form name="RECIBE" action="recibe_hoja_ruta.php" method="post">
