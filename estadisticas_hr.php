...
$rowus = mysqli_fetch_array($resultus);?>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<h2 class="pageTitle">ESTADÍSTICAS</h2>
			</div>
		</div>
	</div>
	</section>
...
<div class="row">
  ...
  <a href="examples/areaspline/hojas_ruta_diaria.php" target="_blank" onClick="window.open(this.href, this.target, 'width=1000,height=500,scrollbars=YES'); return false;">
...
<div class="row">
  <div class="col-md-6"><h4>POR TIPO DE HOJA DE RUTA:</h4><h4 class="text-muted">&nbsp;</h4></div>
  <div class="col-md-6"><h4>
  <a href="examples/3d-pie/por_tipo_hr.php" target="_blank" onClick="window.open(this.href, this.target, 'width=1000,height=700,scrollbars=YES'); return false;">
    MOSTRAR REPORTE </a></h4></div>
</div>
