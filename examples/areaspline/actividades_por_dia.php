...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'CANTIDAD DE ACTIVIDADES DE SOPORTE TECNICO REALIZADAS CADA DIA A NIVEL UNIDAD DE SISTEMAS'
        },
        legend: {
            layout: 'vertical',
            align: 'left',
...
$link=Conectarse();
$sql = " SELECT idactiv_soporte, fecha_activ, idarea FROM activ_soporte GROUP BY fecha_activ ORDER BY fecha_activ";
...
while ($field = mysql_fetch_field($result)){
	...
	$link7=Conectarse();
$sql7 = " SELECT idactiv_soporte FROM activ_soporte WHERE fecha_activ='$row[1]'";
$result7 = mysql_query($sql7, $link7);

$actividades_dia = mysql_num_rows($result7);

?>



             <? echo $actividades_dia; ?>
