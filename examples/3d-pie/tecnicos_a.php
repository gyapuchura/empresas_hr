...
$link0=Conectarse();
$sql0 = " SELECT * FROM activ_soporte ";
$result0 = mysql_query($sql0, $link0);
$total = mysql_num_rows($result0);

$link=Conectarse();
$sql = " SELECT * FROM activ_soporte WHERE tecnico = '37' ";
$result = mysql_query($sql, $link);
$gon = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM activ_soporte WHERE tecnico = '40'";
$result = mysql_query($sql, $link);
$vla = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM activ_soporte WHERE tecnico = '352' ";
$result = mysql_query($sql, $link);
$ame = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM activ_soporte WHERE tecnico = '38'";
$result = mysql_query($sql, $link);
$hans = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM activ_soporte WHERE tecnico = '131'";
$result = mysql_query($sql, $link);
$jose = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM activ_soporte WHERE tecnico = '39'";
$result = mysql_query($sql, $link);
...
<table width="595" border="1" align="center" bordercolor="#009999">
        ...
        <tr>
          ...
          <td bgcolor="#FFFFFF" align="center"><a href="imprime_tecnico_a.php?tecnico=37" target="_blank" class="Estilo12" onClick="window.open(this.href, this.target, 'width=750,height=1000,scrollbars=YES'); return false;"> VER DETALLE </a></td>
         ...
         <tr>
          ...
          <td bgcolor="#FFFFFF" align="center"><a href="imprime_tecnico_a.php?tecnico=40" target="_blank" class="Estilo12" onClick="window.open(this.href, this.target, 'width=750,height=1000,scrollbars=YES'); return false;"> VER DETALLE </a></td>
         ...
         <tr>
          ...
          <td bgcolor="#FFFFFF" align="center"><a href="imprime_tecnico_a.php?tecnico=352" target="_blank" class="Estilo12" onClick="window.open(this.href, this.target, 'width=750,height=1000,scrollbars=YES'); return false;"> VER DETALLE </a></td>
 		...
 		<tr>
          ...
          <td bgcolor="#FFFFFF" align="center"><a href="imprime_tecnico_a.php?tecnico=38" target="_blank" class="Estilo12" onClick="window.open(this.href, this.target, 'width=750,height=1000,scrollbars=YES'); return false;"> VER DETALLE </a></td>
          <td bgcolor="#FFFFFF" align="center"><div align="center"><span class="Estilo7"><?echo $hans;?></span></div></td>
        </tr>
        <tr>
          <td width="269" bgcolor="#FFFFFF"><div align="center"><span class="Estilo8 Estilo1 Estilo2">Jose Luis Mancilla</span></div></td>
          <td bgcolor="#FFFFFF" align="center"><a href="imprime_tecnico_a.php?tecnico=131" target="_blank" class="Estilo12" onClick="window.open(this.href, this.target, 'width=750,height=1000,scrollbars=YES'); return false;"> VER DETALLE </a></td>
          <td bgcolor="#FFFFFF" align="center"><div align="center"><span class="Estilo7"><?echo $jose;?></span></div></td>
        </tr>

         <tr>
          <td width="269" bgcolor="#FFFFFF"><div align="center"><span class="Estilo8 Estilo1 Estilo2">Marco Antonio Mamani</span></div></td>
          <td bgcolor="#FFFFFF" align="center"><a href="imprime_tecnico_a.php?tecnico=39" target="_blank" class="Estilo12" onClick="window.open(this.href, this.target, 'width=750,height=1000,scrollbars=YES'); return false;"> VER DETALLE </a></td>
