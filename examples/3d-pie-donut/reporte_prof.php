...
<body>
    ...
    <br />ATENDIDOS POR:  <br />usuario = <? echo $row8[0]; ?></p>
    ...
    <table width="660" border="1" align="center" bordercolor="#006666" bgcolor="#FFFFFF">
      <tr>
        ...
        <td width="73" ><div align="center"><span class="Estilo24">MONTO<br />
        Bs.</span>          
          </div>
        </div></td>
...
$sql.= " fecha_conformidad, idnombre, idprofesional, precio_ref FROM procesos WHERE idprofesional='$idprofesional' ORDER BY idproceso  DESC ";
...
<? echo $row3[4]; ?></strong></span></div></td>
        ...
        <td><div align="left" class="Estilo21">
          <div align="center"><span class="Estilo20"><? echo $row[11]; ?> Bs
