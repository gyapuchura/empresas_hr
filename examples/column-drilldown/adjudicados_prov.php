...
<html>
	<head>
		...
		<title>mONTOS PROCESOS UNIDADES</title>
...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'TRAMITES ADJUDICADOS AL PROVEEDOR'
        },
...
$numero = 0;
$link=Conectarse();
$sql = " SELECT  idproceso, idnombre, idarea FROM procesos WHERE est_proceso='ADJUDICADO AL PROVEEDOR' GROUP BY idarea ORDER BY idproceso ";
...
$link8=Conectarse();
$sql8 = " SELECT  unidad.nombreunidad, direccion.nombredireccion FROM unidad,areas,direccion WHERE areas.idunidad=unidad.idunidad ";
$sql8.= " AND direccion.iddireccion=areas.iddireccion AND areas.idarea='$idarea' ";
...
{name: '<? echo $row8[0];?> - <? echo $row8[1];?>',
            data: [

            <?
$numero2 = 0;
$link2=Conectarse();
$sql2 = " SELECT  idproceso, idnombre, precio_ref FROM procesos WHERE est_proceso='ADJUDICADO AL PROVEEDOR' AND idarea='$idarea'";
...
<div id="container" style="min-width: 1200px; max-width: 2000px; height: 2000px; margin: 0 auto;"></div>
