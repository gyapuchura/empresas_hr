...
$link=Conectarse();
$sql = " SELECT * FROM equipos WHERE sistema LIKE '%WINDOWS XP%' ";
$result = mysql_query($sql, $link);
$uno = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM equipos WHERE sistema LIKE '%WINDOWS 7%'";
$result = mysql_query($sql, $link);
$dos = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM equipos WHERE sistema LIKE '%WINDOWS 8%' ";
$result = mysql_query($sql, $link);
$tres = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM equipos WHERE sistema LIKE '%WINDOWS 10%' ";
$result = mysql_query($sql, $link);
$cuatro = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM equipos WHERE sistema LIKE '%LINUX%' ";
$result = mysql_query($sql, $link);
$cinco = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM equipos WHERE sistema LIKE '%MAC%'";
$result = mysql_query($sql, $link);
...
<table width="400" border="1" align="center" bordercolor="#009999">
                 <tr>
        ...
        <tr>
          <td width="264" bgcolor="#FFFFFF"><span class="Estilo8 Estilo1 Estilo2">WINDOWS XP</span></td>
          <td bgcolor="#FFFFFF" align="center"><span class="Estilo7"><?echo $uno;?></span></td>
        </tr>
         <tr>
          <td width="264" bgcolor="#FFFFFF"><span class="Estilo8 Estilo1 Estilo2">WINDOWS 7 </span></td>
          <td bgcolor="#FFFFFF" align="center"><span class="Estilo7"><?echo $dos;?></span></td>
        </tr>
         <tr>
          <td width="264" bgcolor="#FFFFFF"><span class="Estilo8 Estilo1 Estilo2">WINDOWS 8 </span></td>
          <td bgcolor="#FFFFFF" align="center"><span class="Estilo7"><?echo $tres;?></span></td>
        </tr>
 		<tr>
          <td width="264" bgcolor="#FFFFFF"><span class="Estilo8 Estilo1 Estilo2">WINDOWS 10 </span></td>
          <td bgcolor="#FFFFFF" align="center"><span class="Estilo7"><?echo $cuatro;?></span></td>
        </tr>
         		<tr>
          <td width="264" bgcolor="#FFFFFF"><span class="Estilo8 Estilo1 Estilo2">LINUX</span></td>
          <td bgcolor="#FFFFFF" align="center"><span class="Estilo7"><?echo $cinco;?></span></td>
        </tr>
        <tr>
          <td width="264" bgcolor="#FFFFFF"><span class="Estilo8 Estilo1 Estilo2">MAC OS X</span></td>
