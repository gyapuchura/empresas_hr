...
?> Responsable: <br /> <?echo $row0[2];?> <?echo $row0[0];?>
 ...
 <p align ="center">
               <a href="tipo_solicitud.php?tecnico=<?echo $tecnico;?>" target="_blank" onClick="window.open(this.href, this.target, 'width=1400,height=900,scrollbars=YES'); return false;">
...
$link=Conectarse();
$sql = "SELECT idsoporte, tecnico, solicitante, fecha_solic, tipoproblema";
$sql.= " FROM soporte WHERE tecnico='$tecnico' ORDER BY idsoporte ";
...
?> <?echo $row1[2];?> <?echo $row1[0];?>
      ...
      <td bgcolor="#FFFFFF"><span class="Estilo13 Estilo23 Estilo22 Estilo21"><?echo $row[4];?></span></td>
  </tr>
