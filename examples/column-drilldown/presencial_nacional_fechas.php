...
$link0=Conectarse();
$sql0 = " SELECT * FROM eventoi WHERE gestion='$gestion' AND idmodalidad='1' AND inicio BETWEEN '$inicio_ss' AND '$fin_ss' ";
$result0 = mysql_query($sql0, $link0);
$total = mysql_num_rows($result0);

$link=Conectarse();
$sql = " SELECT * FROM eventoi WHERE iddepartamento='1' AND idmodalidad='1' AND gestion='$gestion' AND inicio BETWEEN '$inicio_ss' AND '$fin_ss'";
$result = mysql_query($sql, $link);
$ben = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM eventoi WHERE iddepartamento='2' AND idmodalidad='1' AND gestion='$gestion' AND inicio BETWEEN '$inicio_ss' AND '$fin_ss'";
$result = mysql_query($sql, $link);
$cba = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM eventoi WHERE iddepartamento='3' AND idmodalidad='1' AND gestion='$gestion' AND inicio BETWEEN '$inicio_ss' AND '$fin_ss'";
$result = mysql_query($sql, $link);
$chu = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM eventoi WHERE iddepartamento='4' AND idmodalidad='1' AND gestion='$gestion' AND inicio BETWEEN '$inicio_ss' AND '$fin_ss'";
$result = mysql_query($sql, $link);
$lpz = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM eventoi WHERE iddepartamento='5' AND idmodalidad='1' AND gestion='$gestion' AND inicio BETWEEN '$inicio_ss' AND '$fin_ss'";
$result = mysql_query($sql, $link);
$oru = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM eventoi WHERE iddepartamento='6' AND idmodalidad='1' AND gestion='$gestion' AND inicio BETWEEN '$inicio_ss' AND '$fin_ss'";
$result = mysql_query($sql, $link);
$pnd = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM eventoi WHERE iddepartamento='7' AND idmodalidad='1' AND gestion='$gestion' AND inicio BETWEEN '$inicio_ss' AND '$fin_ss'";
$result = mysql_query($sql, $link);
$pts = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM eventoi WHERE iddepartamento='8' AND idmodalidad='1' AND gestion='$gestion' AND inicio BETWEEN '$inicio_ss' AND '$fin_ss'";
$result = mysql_query($sql, $link);
$scz = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM eventoi WHERE iddepartamento='9' AND idmodalidad='1' AND gestion='$gestion' AND inicio BETWEEN '$inicio_ss' AND '$fin_ss'";
$result = mysql_query($sql, $link);
    ...
    Highcharts.data({
        ...
        parsed: function (columns) {
            ...
            $('#container').highcharts({
                ...
                title: {
                    text: 'EVENTOS DE CAPACITACIÓN PRESENCIAL DEL <?echo $inicio_ss;?> AL <?echo $fin_ss;?> '
                },
                subtitle: {
                    text: 'En la gráfica se muestran los eventos por departamento en el intervalo de fechas indicado. '
                },
                xAxis: {
                    type: 'category'
                },
 ...
 <table width="777" border="1" align="center" bordercolor="#009999">
    ...
    MOSTRAR</a>
          ...
          <a href="reporte_tipo_proceso.php?iddepartamento=" target="_blank" class="Estilo12" onClick="window.open(this.href, this.target, 'width=750,height=1000,scrollbars=YES'); return false;"> VER DETALLE </a>          </td>
                ...
                <tr>
          <td width="272" bgcolor="#FFFFFF"><span class="Estilo8 Estilo1 Estilo2">TOTAL  DE EVENTOS</span></td>
