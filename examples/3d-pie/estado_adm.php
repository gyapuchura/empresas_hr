...
$link=Conectarse();
$sql = " SELECT * FROM eventoi WHERE idestado_adm ='1'";
$result = mysql_query($sql, $link);
$ben = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM eventoi WHERE idestado_adm ='2'";
$result = mysql_query($sql, $link);
$cba = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM eventoi WHERE idestado_adm ='3'";
$result = mysql_query($sql, $link);
$chu = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM eventoi WHERE idestado_adm ='4'";
$result = mysql_query($sql, $link);
$lpz = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM eventoi WHERE idestado_adm ='5'";
$result = mysql_query($sql, $link);
$oru = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM eventoi WHERE idestado_adm ='6'";
$result = mysql_query($sql, $link);
...
$link=Conectarse();
$sql = " SELECT * FROM eventoi WHERE idestado_adm ='7'";
$result = mysql_query($sql, $link);
$pts = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM eventoi WHERE idestado_adm ='8'";
$result = mysql_query($sql, $link);
$scz = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM eventoi WHERE idestado_adm ='10'";
$result = mysql_query($sql, $link);
$scz = mysql_num_rows($result);
