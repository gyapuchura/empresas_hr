...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'TRAMITES CON CERTIFICACION PRESUPUESTARIA'
        },
...
$numero = 0;
$link=Conectarse();
$sql = " SELECT  idproceso, idnombre, idarea FROM procesos WHERE est_proceso='CON CERTIFICACION PRESUPUESTARIA' GROUP BY idarea ORDER BY idproceso ";
...
$numero2 = 0;
$link2=Conectarse();
$sql2 = " SELECT  idproceso, idnombre, precio_ref FROM procesos WHERE est_proceso='CON CERTIFICACION PRESUPUESTARIA' AND idarea='$idarea'";
