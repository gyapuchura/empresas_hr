...
$sql1.= " fecha_corres, anexo FROM corres WHERE idcorres='$idcorres' ";
...
<section id="inner-headline">
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<h2 class="pageTitle">RECIBIR LA COMUNICACIÓN INTERNA N° <?php echo $row1[2];?>/<?php echo $row1[1];?></h2>
			</div>
		</div>
	</div>
</section>
...
<div class="col-md-12"> 
<h2>
<form name="DERIVA" action="nuevas_comunicaciones.php" method="post">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="myModalLabel"></h5>
         <div class="panel panel-info">
  				<div class="panel-heading"><h3>¿Esta seguro de recibir esta comunicacion interna?</h3></div>
         </div>
      ...
      <input type="hidden" id="idderiva_corres"  name="idderiva_corres" value="<?php echo $idderiva_corres;?>">
        <button type="submit" class="btn btn-primary">RECIBIR COMUNICACION</button>
        </form>
      </div>
    </div>
  </div>
