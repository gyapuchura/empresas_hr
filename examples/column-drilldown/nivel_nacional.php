...
$link=Conectarse();
$sql = " SELECT * FROM eventoi WHERE iddepartamento='1' AND gestion='$gestion' ";
$result = mysql_query($sql, $link);
$ben = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM eventoi WHERE iddepartamento='2' AND gestion='$gestion' ";
$result = mysql_query($sql, $link);
$cba = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM eventoi WHERE iddepartamento='3' AND gestion='$gestion' ";
$result = mysql_query($sql, $link);
$chu = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM eventoi WHERE iddepartamento='4' AND gestion='$gestion' ";
$result = mysql_query($sql, $link);
$lpz = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM eventoi WHERE iddepartamento='5' AND gestion='$gestion' ";
$result = mysql_query($sql, $link);
$oru = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM eventoi WHERE iddepartamento='6' AND gestion='$gestion' ";
$result = mysql_query($sql, $link);
$pnd = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM eventoi WHERE iddepartamento='7' AND gestion='$gestion' ";
$result = mysql_query($sql, $link);
$pts = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM eventoi WHERE iddepartamento='8' AND gestion='$gestion' ";
$result = mysql_query($sql, $link);
$scz = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM eventoi WHERE iddepartamento='9' AND gestion='$gestion' ";
$result = mysql_query($sql, $link);
    ...
    Highcharts.data({
        ...
        parsed: function (columns) {
            ...
            $('#container').highcharts({
                ...
                title: {
                    text: '<?echo "EVENTOS DE CAPACITACION A NIVEL NACIONAL"?>'
                },
                subtitle: {
...
TARIJA	<?echo $tarija;?>%
 ...
 <table width="777" border="1" align="center" bordercolor="#009999">
        ...
        <tr>
          ...
          <td bgcolor="#FFFFFF" align="center"> <?echo $beni;?> </td>
