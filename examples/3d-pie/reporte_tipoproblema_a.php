...
<?php
$link0=Conectarse();
$sql0 = " SELECT * FROM activ_soporte WHERE tecnico='$tecnico' AND idtipo_sol='$idtipo_sol'";
$result0 = mysql_query($sql0, $link0);
$total = mysql_num_rows($result0);

?>     <br /> TOTAL DE SOLICITUDES ATENDIDAS = <?echo $total;?>   <br />      <br />
 <?

$link6=Conectarse();
$sql6 = "SELECT idtipo_sol, nombre_tiposol ";
$sql6.= " FROM tipo_sol WHERE idtipo_sol='$idtipo_sol' ";
...
$sql.= " FROM activ_soporte WHERE tecnico='$tecnico' AND idtipo_sol='$idtipo_sol' ORDER BY idactiv_soporte ";
