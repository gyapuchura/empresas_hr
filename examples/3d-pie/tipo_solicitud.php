...
$link0=Conectarse();
$sql0 = " SELECT * FROM soporte WHERE tecnico='$tecnico'";
$result0 = mysql_query($sql0, $link0);
$total = mysql_num_rows($result0);

$link=Conectarse();
$sql = " SELECT * FROM soporte WHERE tipoproblema = 'Reinstalación del equipo de Computación' AND tecnico='$tecnico'";
$result = mysql_query($sql, $link);
$uno = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM soporte WHERE tipoproblema = 'Desinfección y actualización de antivirus' AND tecnico='$tecnico'";
$result = mysql_query($sql, $link);
$dos = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM soporte WHERE tipoproblema = 'Desbloqueo y reacondicionamiento de PC' AND tecnico='$tecnico'";
$result = mysql_query($sql, $link);
$tres = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM soporte WHERE tipoproblema = 'Instalación de Software' AND tecnico='$tecnico'";
$result = mysql_query($sql, $link);
$cuatro = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM soporte WHERE tipoproblema = 'Instalación de Cableado de red' AND tecnico='$tecnico'";
$result = mysql_query($sql, $link);
$cinco = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM soporte WHERE tipoproblema = 'Mantenimiento de Impresoras' AND tecnico='$tecnico'";
$result = mysql_query($sql, $link);
$seis = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM soporte WHERE tipoproblema = 'Mantenimiento preventivo y correctivo' AND tecnico='$tecnico'";
$result = mysql_query($sql, $link);
$siete = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM soporte WHERE tipoproblema = 'Capacitación de Software' AND tecnico='$tecnico'";
$result = mysql_query($sql, $link);
$ocho = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM soporte WHERE tipoproblema = 'Instalación y cableado telefónico' AND tecnico='$tecnico'";
$result = mysql_query($sql, $link);
$nueve = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM soporte WHERE tipoproblema = 'Realizacion de Respaldo de informacion' AND tecnico='$tecnico'";
$result = mysql_query($sql, $link);
$diez = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM soporte WHERE tipoproblema = 'Problema al acceder a Internet' AND tecnico='$tecnico'";
$result = mysql_query($sql, $link);
$once = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM soporte WHERE tipoproblema = 'Verificacion de Caracteristicas Tecnicas' AND tecnico='$tecnico'";
$result = mysql_query($sql, $link);
$doce = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM soporte WHERE tipoproblema = 'Telefonia interna VoiP' AND tecnico='$tecnico'";
$result = mysql_query($sql, $link);
$trece = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM soporte WHERE tipoproblema = 'Problemas con el Encendido del C.P.U.' AND tecnico='$tecnico'";
$result = mysql_query($sql, $link);
$catorce = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM soporte WHERE tipoproblema = 'Problemas con Periferico' AND tecnico='$tecnico'";
$result = mysql_query($sql, $link);
$quince = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM soporte WHERE tipoproblema = 'Problema de acceso a SIGMA' AND tecnico='$tecnico'";
$result = mysql_query($sql, $link);
$dieciseis = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM soporte WHERE tipoproblema = 'Desbloqueo de PC' AND tecnico='$tecnico'";
$result = mysql_query($sql, $link);
$diecisiete = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM soporte WHERE tipoproblema = 'Instalación del equipo de Computación'AND tecnico='$tecnico' ";
$result = mysql_query($sql, $link);
$dieciocho = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM soporte WHERE tipoproblema = 'Solicitud de Diagnostico Tecnico' AND tecnico='$tecnico'";
$result = mysql_query($sql, $link);
$diecinueve = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM soporte WHERE tipoproblema = 'Reparacion de Equipo de Computacion Portatil' AND tecnico='$tecnico'";
$result = mysql_query($sql, $link);
$veinte = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM soporte WHERE tipoproblema = 'Problemas con Sistema de Seguridad' AND tecnico='$tecnico'";
$result = mysql_query($sql, $link);
$veintiuno = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM soporte WHERE tipoproblema = 'Solicitud de Verificacion Tecnica' AND tecnico='$tecnico'";
$result = mysql_query($sql, $link);
$veintidos = mysql_num_rows($result);

$link=Conectarse();
$sql = " SELECT * FROM soporte WHERE tipoproblema = 'Configuracion de RED para Video Conferencia Internacional' AND tecnico='$tecnico'";
$result = mysql_query($sql, $link);
