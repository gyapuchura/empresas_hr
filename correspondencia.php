...
$resultus = mysqli_query($sqlus,$linkus);
...
<section id="inner-headline">
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<h2 class="pageTitle">COMUNICACIONES INTERNAS CENCAP</h2>
			</div>
		</div>
	</div>
</section>
...
<div class="row" align="center"><h2>
  <form name="EVENTO" action="nuevo_eventoi.php" method="post">
  <button type="submit" class="btn-link">NUEVA COMUNICACION INTERNA</button></form>
 </h2>
 </div>
...
while ($field = mysqli_fetch_field($result)){
	...
	$resultu = mysqli_query($sqlu,$linku);
